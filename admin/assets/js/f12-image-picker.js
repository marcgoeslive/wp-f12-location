jQuery(function ($) {
     ...
     */
    $('body').on('click', '.f12-image-picker-upload-button', function (e) {
        e.preventDefault();
        ...
        custom_uploader.on('select', function () { // it also has "open" and "close" events
            ...
            attachments.each(function (attachment) {
                $(button).parent().find(output).append('<div data-key="' + attachment["id"] + '">' +
                    ...
                    '<a href="#" class="f12-image-picker-remove-button">Bild entfernen</a>' +
     ...
     * Remove image event
     */
    $('body').on('click', '.f12-image-picker-remove-button', function () {
        $(this).parent().remove();
        return false;
    });
