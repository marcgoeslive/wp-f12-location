	...
	<div class="f12-panel__content">
		<table class="f12-table">
			<tr>
				...
				<td>
					<input id="buy_title" type="text" name="buy_2_title" class="f12-form-validate"
					       validation='{"validation":{"required":true}}'
					       value="<?php echo $args["buy_2_title"]; ?>"/>
				</td>
			</tr>
			<tr>
				<th colspan="2">
			...
			<tr>
				...
				<td>
					<input id="no_buy_title" type="text" name="no_buy_2_title" class="f12-form-validate"
					       validation='{"validation":{"required":true}}'
					       value="<?php echo $args["no_buy_2_title"]; ?>"/>
				</td>
			</tr>
			<tr>
				<td class="label">
				...
				<td>
					<?php echo wp_editor( $args["no_buy_2_text"], "no_buy_2_text", array( "editor_class" => "f12-form-validate" ) ); ?>
				</td>
			</tr>
		</table>
	</div>
