	...
	<div class="f12-panel__content">
		<table class="f12-table">
			<tr>
				...
				<td>
					<input id="rent_title" type="text" name="rent_2_title" class="f12-form-validate"
					       validation='{"validation":{"required":true}}'
					       value="<?php echo $args["rent_2_title"]; ?>"/>
				</td>
			</tr>
			<tr>
				<th colspan="2">
			...
			<tr>
				...
				<td>
					<input type="text" name="no_rent_2_title" class="f12-form-validate"
					       validation='{"validation":{"required":true}}'
					       value="<?php echo $args["no_rent_2_title"]; ?>"/>
				</td>
			</tr>
			<tr>
				<td class="label">
				...
				<td>
					<?php echo wp_editor( $args["no_rent_2_text"], "no_rent_2_text" ); ?>
				</td>
			</tr>
		</table>
	</div>
