 ...
 */
class F12LocationCategoryOverview {
	public function __construct() {
		//add_filter( 'manage_f12_contact_columns', array( &$this, "set_columns" ) );
		add_filter( 'manage_' . F12_CPT . 'category_posts_columns', array( &$this, "posts_columns" ) );
		add_action( 'manage_' . F12_CPT . 'category_posts_custom_column', array( &$this, "custom_columns" ), 10, 2 );
	}
