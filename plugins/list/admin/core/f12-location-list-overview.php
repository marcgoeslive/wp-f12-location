 ...
 */
class F12LocationListOverview {
	public function __construct() {
		//add_filter( 'manage_f12_contact_columns', array( &$this, "set_columns" ) );
		add_filter( 'manage_' . F12_CPT . 'list_posts_columns', array( &$this, "posts_columns" ) );
		add_action( 'manage_' . F12_CPT . 'list_posts_custom_column', array( &$this, "custom_columns" ), 10, 2 );
	}
	...
	public function custom_columns( $column, $post_id ) {
		...
		switch ( $column ) {
			...
			case 'counter':
				...
				break;
			case 'shortcode':
				echo "[f12-location-list-" . $item->post_name . "]";
				break;
		}
	}
